	...
	var templates = {
		"font-styles": "<li class='dropdown'>" +
						    ...
						    "<ul class='dropdown-menu'>" +
					            ...
					            "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h3'>Título 3</a></li>" +
					            "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h4'>Título 4</a></li>" +
						    "</ul>" +
						"</li>",
		"emphasis":     "<li>" +
							"<div class='btn-group'>" 
		...
		"link": 	"<li>" 
						...
						+ "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>"
							...
							+ "<div class='modal-footer'>"
							  ...
							  + "<a href='#' class='btn btn-primary' data-dismiss='modal'>Agregar</a>"
							+ "</div>"
						+ "</div>"
